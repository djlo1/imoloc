...
export default function Header({ onMenuClick, onToggleSidebar }) {
  ...
  return (
    <>
      <style>{`
        .hd3{height:48px;background:#1c2434;border-bottom:1px solid rgba(255,255,255,0.06);display:flex;align-items:center;padding:0;position:sticky;top:0;z-index:200;flex-shrink:0;gap:0}
        .hd3-left{display:flex;align-items:center;gap:0;padding:0 8px;flex-shrink:0}
        ...
        .hd3-brand{display:flex;align-items:center;gap:8px;padding:0 8px 0 4px;cursor:pointer;text-decoration:none;flex-shrink:0}
        ...
        .hd3-search{display:flex;align-items:center;gap:8px;background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.09);border-radius:4px;padding:7px 14px;width:100%;max-width:580px;transition:all 0.15s}
        ...
        .hd3-icon-btn{display:flex;align-items:center;justify-content:center;width:36px;height:36px;border-radius:4px;cursor:pointer;border:none;background:none;color:rgba(255,255,255,0.5);transition:all 0.1s;position:relative;flex-shrink:0}
        ...
        /* Dropdowns */
        .hd3-dropdown{position:absolute;background:#1c2434;border:1px solid rgba(255,255,255,0.09);box-shadow:0 8px 32px rgba(0,0,0,0.6);z-index:300;border-radius:6px;overflow:hidden}
        .hd3-dropdown-right{right:0}
        ...
        /* Notifications */
        .hd3-notif-menu{width:340px;top:calc(100% + 4px)}
        ...
        .hd3-notif-title{font-size:14px;font-weight:600;color:#e6edf3}
        .hd3-notif-clear{font-size:12px;color:#4da6ff;cursor:pointer;background:none;border:none;font-family:'Inter',sans-serif}
        .hd3-notif-list{max-height:320px;overflow-y:auto}
        ...
        .hd3-notif-text{font-size:13px;color:#e6edf3;margin-bottom:3px;font-weight:500}
        .hd3-notif-time{font-size:11px;color:rgba(255,255,255,0.25)}
        .hd3-notif-footer{padding:10px 16px;border-top:1px solid rgba(255,255,255,0.06);text-align:center}
        .hd3-notif-all{font-size:13px;color:#4da6ff;text-decoration:none;cursor:pointer}

        /* Settings */
        .hd3-settings-menu{width:280px;top:calc(100% + 4px)}
        .hd3-settings-head{padding:14px 16px;border-bottom:1px solid rgba(255,255,255,0.07);font-size:14px;font-weight:600;color:#e6edf3}
        .hd3-settings-section{padding:10px 16px 6px;font-size:11px;font-weight:600;letter-spacing:0.08em;text-transform:uppercase;color:rgba(255,255,255,0.3)}
        .hd3-settings-item{display:flex;align-items:center;justify-content:space-between;padding:9px 16px;cursor:pointer;transition:background 0.1s}
        .hd3-settings-item:hover{background:rgba(255,255,255,0.04)}
        .hd3-settings-item-left{display:flex;align-items:center;gap:10px;font-size:13.5px;color:rgba(255,255,255,0.65)}
        ...
        /* Nouveautés */
        .hd3-news-menu{width:360px;top:calc(100% + 4px)}
        .hd3-news-head{padding:14px 16px;border-bottom:1px solid rgba(255,255,255,0.07)}
        .hd3-news-title{font-size:14px;font-weight:600;color:#e6edf3;margin-bottom:2px}
        .hd3-news-sub{font-size:12px;color:rgba(255,255,255,0.3)}
        .hd3-news-list{max-height:360px;overflow-y:auto}
        ...
        .hd3-news-item-title{font-size:13.5px;font-weight:600;color:#e6edf3;margin-bottom:4px}
        .hd3-news-item-desc{font-size:12.5px;color:rgba(255,255,255,0.4);line-height:1.5;margin-bottom:4px}
        .hd3-news-item-date{font-size:11px;color:rgba(255,255,255,0.2)}

        /* Profile */
        .hd3-profile-menu{width:260px;top:calc(100% + 4px)}
        ...
        .hd3-profile-name{font-size:14px;font-weight:600;color:#e6edf3}
        .hd3-profile-role{font-size:12px;color:rgba(255,255,255,0.35);margin-top:2px}
        ...
        .hd3-profile-danger{color:rgba(239,68,68,0.7)!important}
        .hd3-profile-danger:hover{background:rgba(239,68,68,0.07)!important;color:#ef4444!important}

        @media(max-width:900px){.hd3-brand-name{display:none}}
        @media(max-width:768px){.hd3-search-hint{display:none}}
        @media(max-width:600px){.hd3-center{padding:0 8px}}
      `}</style>
      ...
      <header className="hd3">
        ...
        <div className="hd3-left">
          ...
          <div style={{position:'relative'}}>
            <button className="hd3-waffle" onClick={() => { closeAll(); setWaffleOpen(!waffleOpen) }}>
            ...
            {waffleOpen && (
              <div className="hd3-dropdown hd3-waffle-menu" style={{position:'absolute',top:'calc(100% + 4px)',left:0}}>
        ...
        <div className="hd3-right">
          ...
          {/* Nouveautés */}
          <div style={{position:'relative'}}>
            <button className="hd3-icon-btn" title="Nouveautés" onClick={() => { closeAll(); setNouveautesOpen(!nouveautesOpen) }}>
            ...
            {nouveautesOpen && (
              <div className="hd3-dropdown hd3-dropdown-right hd3-news-menu" style={{position:'absolute'}}>
                <div className="hd3-news-head">
                  <div className="hd3-news-title">Nouveautés Imoloc</div>
                  <div className="hd3-news-sub">Dernières fonctionnalités et améliorations</div>
                </div>
                <div className="hd3-news-list">
                  {NOUVEAUTES.map((n,i) => (
                    <div key={i} className="hd3-news-item">
                      ...
                      <div className="hd3-news-item-title">{n.title}</div>
                      <div className="hd3-news-item-desc">{n.desc}</div>
                      <div className="hd3-news-item-date">{n.date}</div>
                    </div>
                  ))}
                </div>
              </div>
          ...
          {/* Notifications */}
          <div style={{position:'relative'}}>
            <button className="hd3-icon-btn" title="Notifications" onClick={() => { closeAll(); setNotifOpen(!notifOpen) }}>
              <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
            ...
            {notifOpen && (
              <div className="hd3-dropdown hd3-dropdown-right hd3-notif-menu" style={{position:'absolute'}}>
                <div className="hd3-notif-head">
                  <span className="hd3-notif-title">Notifications</span>
                  <button className="hd3-notif-clear">Tout marquer comme lu</button>
                </div>
                <div className="hd3-notif-list">
                  {NOTIFS.map((n,i) => (
                    <div key={i} className={`hd3-notif-item ${!n.read?'unread':''}`}>
                      <div className="hd3-notif-dot" style={{background:n.dot}}/>
                      <div>
                        <div className="hd3-notif-text">{n.title}</div>
                        <div className="hd3-notif-time">{n.time}</div>
                      </div>
                    </div>
                  ))}
                </div>
                <div className="hd3-notif-footer">
                  <span className="hd3-notif-all">Afficher toutes les notifications</span>
                </div>
              </div>
            )}
          </div>
          ...
          {/* Paramètres */}
          <div style={{position:'relative'}}>
            <button className="hd3-icon-btn" title="Paramètres" onClick={() => { closeAll(); setSettingsOpen(!settingsOpen) }}>
              <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
            ...
            {settingsOpen && (
              <div className="hd3-dropdown hd3-dropdown-right hd3-settings-menu" style={{position:'absolute'}}>
                <div className="hd3-settings-head">Paramètres</div>
                <div className="hd3-settings-section">Affichage</div>
                <div className="hd3-settings-item">
                  <span className="hd3-settings-item-left">
                ...
                <div className="hd3-settings-section">Organisation</div>
                <Link to="/agence/parametres" className="hd3-settings-item" onClick={closeAll} style={{textDecoration:'none'}}>
                  <span className="hd3-settings-item-left">
                    <svg width="14" height="14" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24"><path strokeLinecap="round" d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h1.5m-1.5 3h1.5m-1.5 3h1.5m3-6H15m-1.5 3H15m-1.5 3H15M9 21v-3.375c0-.621.504-1.125 1.125-1.125h3.75c.621 0 1.125.504 1.125 1.125V21"/></svg>
                    Paramètres de l'organisation
                  </span>
                </Link>
                <Link to="/agence/securite" className="hd3-settings-item" onClick={closeAll} style={{textDecoration:'none'}}>
                  <span className="hd3-settings-item-left">
          ...
          {/* Profil */}
          <div style={{position:'relative'}}>
            <div className="hd3-avatar" onClick={() => { closeAll(); setProfileOpen(!profileOpen) }}>
              {profile?.prenom?.[0]?.toUpperCase() || 'A'}
            </div>
            {profileOpen && (
              <div className="hd3-dropdown hd3-dropdown-right hd3-profile-menu" style={{position:'absolute'}}>
                <div className="hd3-profile-head">
                  <div className="hd3-profile-avatar">{profile?.prenom?.[0]?.toUpperCase() || 'A'}</div>
                  <div>
                    <div className="hd3-profile-name">{profile?.prenom} {profile?.nom}</div>
                    <div className="hd3-profile-role">Administrateur · Imoloc</div>
                  </div>
                </div>
                ...
                <button className="hd3-profile-item hd3-profile-danger" onClick={handleLogout}>
