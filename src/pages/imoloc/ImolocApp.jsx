...
const NAV = [
  ...
  { id:"paiements", label:"Facturation", path:"/imoloc/paiements",
    ...
    children:[
      {label:"Paiements recus", path:"/imoloc/paiements"},
      ...
      {label:"Releves proprietaires", path:"/imoloc/paiements/releves-proprietaires"},
      {label:"Depenses et charges", path:"/imoloc/paiements/depenses-charges"},
    ]
  },
